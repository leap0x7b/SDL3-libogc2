...
bool SDL_OGC_CreateWindowFramebuffer(SDL_VideoDevice *_this, SDL_Window *window, SDL_PixelFormat *format, void **pixels, int *pitch)
{
...
bool SDL_OGC_UpdateWindowFramebuffer(SDL_VideoDevice *_this, SDL_Window *window, const SDL_Rect *rects, int numrects)
{
    SDL_WindowData *windowdata = (SDL_WindowData *)window->internal;
    u32 texture_size;
    u8 gx_format;
...
void SDL_OGC_DestroyWindowFramebuffer(SDL_VideoDevice *_this, SDL_Window *window)
{
